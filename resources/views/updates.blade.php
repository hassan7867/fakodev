...
@section('content')
    ...
    <section  style="padding-top: 200px;">
        ...
        <div style="float: right;margin-top: -15px">
            <h1 style="padding: 10px;background: #4eabc7;color: white;border-bottom-right-radius: 20px;text-align: center;width: 400px">PROJECT UPDATES
            </h1>
        </div>
        <div style="margin-top: 70px">
            <h2 style="background: #ffa600;color: white;width: 400px;padding: 15px">SCHOOL OPENING</h2>
            <hr style=" border: 1px solid black;">
        </div>
        <div class="row" style="margin: 0 auto;max-width: 1000px;margin-top: 120px">
            <div class="col-md-4">
                <img src="{{url('u1.webp')}}">
            </div>
            <div class="col-md-4">
